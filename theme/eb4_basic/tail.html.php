		...
		<div class="container">
			<div class="footer-top">
				<div class="footer-nav">
                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/p2u-logo.png" class="p2u-logo" alt="<?php echo $config['cf_title']; ?>">
				</div>
			...
			<div class="footer-cont-info">
                ...
                <h6 class="contact-row">
                    <span class="text-white">CS CENTER <?php echo $bizinfo['bi_company_tel']; ?></span>
                    <span class="info-divider text-white">|</span>
                    <span class="text-white"><?php echo $bizinfo['bi_cs_time']; ?></span>
                </h6>
                <h6 class="contact-row">
                ...
                <h6 class="contact-row">
                    <span class="text-white"><?php  echo $bizinfo['bi_company_name'] ?></span>
                    <span class="info-divider text-white">|</span>
                    <span class="text-white">대표: <?php  echo $bizinfo['bi_company_ceo'] ?></span>
                </h6>
                <h6 class="contact-row">
                    ...
                    <span class="info-divider">|</span>
                    <span>주소: <?php echo $bizinfo['bi_company_address']; ?></span><br>
                </h6>
			</div>
<!--            <div class="footer-cont-info">-->
<!--                <span><a href="mailto:--><?php //echo $bizinfo['bi_cs_email']; ?><!--">--><?php //echo $bizinfo['bi_cs_email']; ?><!--</a></span>-->
...
<!--            </div>-->
			<div class="footer-copyright">
				<span>Copyright </span>&copy; <strong class="f-w-400"><?php echo $bizinfo['bi_company_bugano']; ?></strong>. All Rights Reserved.
			</div>
